...
training_dataset = CustomDataset("/workdir/SSL/generated_cubes/train/", config = config)
validation_dataset = CustomDataset("/workdir/SSL/generated_cubes/val/", config = config)
