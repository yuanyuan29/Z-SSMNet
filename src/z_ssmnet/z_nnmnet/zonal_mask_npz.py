...
os.chmod(args.save_path, stat.S_IRWXO)
files = glob.glob(args.save_path + "*.pkl")
...
for file in files:
    ...
    with open(file, 'rb') as f:
        ...
        mask = sitk.ReadImage(args.data_path + file_name + ".nii.gz")
        ...
        np.savez_compressed(args.save_path + file_name + "_seg.npz", data = mask_npz)
